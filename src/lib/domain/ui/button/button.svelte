    ...
    export const buttonVariants = tv({
        ...
        variants: {
            ...
            variant: {
                ...
                'destructive-ghost': 'text-destructive shadow-xs hover:bg-destructive/10 focus-visible:ring-destructive/20 dark:bg-destructive/60 dark:focus-visible:ring-destructive/40',
