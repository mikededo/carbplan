...
export type OnboardingService = {
  saveAthleteOnboarding: (data: SaveAthleteOnboardingData) => ResultAsync<OnboardingContract.OnboardingResponse, null>
}

export class DbOnboardingService implements OnboardingService {
  constructor(private readonly db: Db) { }

  saveAthleteOnboarding({ id, ...data }: SaveAthleteOnboardingData): ResultAsync<OnboardingContract.OnboardingResponse, null> {
